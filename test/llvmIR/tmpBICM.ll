...
while.cond:                                       ; preds = %while.end, %entry
  %i.0 = phi i32 [ undef, %entry ], [ %i.1.lcssa, %while.end ]
  %j.0 = phi i32 [ 0, %entry ], [ %add8, %while.end ]
...
while.cond3:                                      ; preds = %while.body6, %while.body
  %fact.0 = phi i32 [ 1, %while.body ], [ %mul, %while.body6 ]
  %i.1 = phi i32 [ 1, %while.body ], [ %add, %while.body6 ]
...
while.end:                                        ; preds = %while.cond3
  %fact.0.lcssa = phi i32 [ %fact.0, %while.cond3 ]
  %i.1.lcssa = phi i32 [ %i.1, %while.cond3 ]
  %call7 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str, i32 0, i32 0), i32 %i.1.lcssa, i32 %fact.0.lcssa)
  %add8 = add nsw i32 %j.0, 1
  br label %while.cond
